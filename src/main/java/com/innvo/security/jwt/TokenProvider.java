package com.innvo.security.jwt;
...
//			log.warn("Warning: the JWT key used is not Base64-encoded. " + "We rezuul:\n" + "   routes:\n"
//					+ "    event:\n" + "      path: /services/event/**\n" + "      url: http://localhost:8081/zuul:\n"
//					+ "   routes:\n" + "    event:\n" + "      path: /services/event/**\n"
//					+ "      url: http://localhost:8081/commend using the `jhipster.security.authentication.jwt.base64-secret` key for optimum security.");
