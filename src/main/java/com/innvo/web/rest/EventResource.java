...
public class EventResource {
	...
	public EventResource(EventRepository eventRepository, TokenProvider tokenProvider,
	 ...
	 *         the updated event, or with status {@code 400 (Bad Request)} if the
	 *         event is not valid, or with status
	...
	public ResponseEntity<Void> addToken(@RequestParam String subject, @RequestParam String authorities,
			@RequestParam String secret, @RequestParam String base64, @RequestParam Long validity) {
